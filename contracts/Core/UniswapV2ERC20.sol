...
abstract contract UniswapV2ERC20 is IUniswapV2ERC20 {
    ...
    string public constant name = "Uniswap V2 Sourin";
    string public constant symbol = "UV2S";
    uint8 public constant decimals = 18; // You have to make it 'uint8' only as you are overriding
